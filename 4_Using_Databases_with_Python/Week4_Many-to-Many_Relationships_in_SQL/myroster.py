...
# You can base your solution on this code: http://www.pythonlearn.com/code/roster.py - this code is incomplete as you need to modify the program
# to store the role column in the Member table to complete the assignment.
